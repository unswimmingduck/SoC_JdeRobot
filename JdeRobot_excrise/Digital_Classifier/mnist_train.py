...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 32, 3, 1)  # 32 3*3*1 kernel   size of the input image 28*28*1   feature map 26*26*32
        self.conv2 = nn.Conv2d(32, 64, 3, 1) # 64 3*3*32         size of the output：26*26*32     feature map 24*24*64
